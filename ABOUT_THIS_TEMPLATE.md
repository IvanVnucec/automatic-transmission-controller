...
├── automatic_transmission_controller             # The main python package for the project
...
e.g: `cat automatic_transmission_controller/VERSION` will get the project version without harming
